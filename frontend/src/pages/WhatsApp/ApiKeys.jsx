...
const ENV_VARS = [
  ...
  },
  {
    ...
    desc: "WhatsApp Business Account (WABA) ID",
  },
  {
    key: "WHATSAPP_ACCESS_TOKEN",
    desc: "Permanent access token from Meta Business settings",
  },
  {
    key: "WHATSAPP_WEBHOOK_VERIFY_TOKEN",
    desc: "Custom token for webhook verification (you choose this value)",
  },
  {
    key: "WHATSAPP_APP_SECRET",
    desc: "App secret from Meta Developer Console for webhook signature validation",
  },
  {
    key: "REDIS_URL",
    desc: "Redis connection URL for message queue (optional, defaults to localhost)",
  },
];
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        >
          ...
          <code className="block bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-sm text-gray-700 font-mono break-all">
            https://pearlscrm-1.onrender.com/api/whatsapp/webhook
          </code>
          <a
        ...
        <div className="space-y-4">
          {ENV_VARS.map((v) => (
            <div key={v.key} className="flex gap-4 p-4 bg-gray-50 rounded-lg">
              <code className="text-sm font-mono text-[#2563a9] font-medium shrink-0 w-72">
                {v.key}
              </code>
