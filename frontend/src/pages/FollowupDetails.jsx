...
export default function FollowupDetails() {
  ...
  const handleActionClick = async (actionType) => {
    ...
    const authorName = user?.displayName || user?.name || user?.employeeName || "Admin";
        ...
        <div className="p-6 border-b border-[#e6e0d8]">
          <div className="flex items-start justify-between">
            ...
            <div className="relative flex gap-4 items-center">
              <div className="w-14 h-14 rounded-2xl bg-[#e7edf8] flex items-center justify-center text-[#3167dc] font-bold text-2xl shadow-xs">
              ...
              <span
                className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${
                  followupbyId?.status === "Completed"
                    ...
                    : followupbyId?.status === "In Progress"
          ...
          <div className="flex items-center justify-between mt-6 flex-wrap gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[#3167dc] bg-[#3167dc] hover:bg-blue-700 text-white text-xs font-bold shadow-xs cursor-pointer transition-all"
              >
                <Pencil size={14} />
                Edit Follow-up
              </button>
