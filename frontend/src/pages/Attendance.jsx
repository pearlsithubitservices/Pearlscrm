  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post(
        "https://pearlscrm-1.onrender.com/api/attendance/login",
        {
      ...
      <div className="flex-1 p-8 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 text-sm mb-2">Weekly Hours</p>

            <h2 className="text-4xl font-black text-[#0f172a]">42h</h2>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 text-sm mb-2">Login Time</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="bg-[#0f172a] rounded-3xl text-center py-12 mb-8">
              ...
              <p className="text-gray-400 mt-4">Today's Work Timer</p>
            </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-500 mt-1">Recent attendance logs</p>
              </div>
            </div>
                ...
                <tbody>
                  {attendanceHistory.map((item, index) => (
                    <tr key={index} className="border-b border-gray-50">
                      ...
                      <td className="py-5 text-gray-600">{item.login}</td>

                      <td className="py-5 text-gray-600">{item.logout}</td>
