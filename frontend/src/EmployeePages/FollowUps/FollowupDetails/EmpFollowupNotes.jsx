...
export default function FollowupNotes({ followup, onRefresh }) {
  ...
  const handleNote = async () => {
    ...
    try {
      ...
      console.error("Error adding employee followup note:", err);
  ...
  const handleDeleteNote = async (originalIndex) => {
    ...
    try {
      ...
      console.error("Error deleting employee note:", err);
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
          ...
          <input
            ...
            placeholder="Note Title / Summary (e.g., Client Call Summary)..."
