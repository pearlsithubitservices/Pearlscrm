        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex gap-3">
              ...
              <span className="px-4 py-1 rounded-full bg-red-100 text-red-500 text-sm">
                Pending
              </span>
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <button className="flex items-center gap-2 px-5 py-2 rounded-md border border-[#d8d8d8] bg-[#ece9e3] text-[#777] text-sm">
