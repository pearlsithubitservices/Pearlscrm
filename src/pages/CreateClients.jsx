...
className="max-w-5xl mx-auto mt-10 bg-[#e9e7e2] rounded-[40px] p-10"
>
...
<button className="px-10 py-4 border rounded-xl" onClick={onclose}>
Cancel
</button>

<button className="flex-1 bg-blue-700 text-white rounded-xl">
