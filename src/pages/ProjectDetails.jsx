    ...
    return (
        ...
        <>
            ...
            <motion.div
                ...
                className="w-full max-w-6xl bg-[#f3f0eb] rounded-[28px] overflow-hidden shadow-2xl min-h-screen"
            >
                        ...
                        <div className=" relative flex items-center gap-5  p-2">
                            ...
                            <div className=" w-[450px]">
                                ...
                                <h1 className="mt-5 text-[20px] leading-tight font-bold text-[#0B2D57]">
                                    TechFlow CRM Implementation
                                </h1>
                            </div>
                            <div className="absolute right-6 top-0 flex -space-x-4">
                                <div className="w-14 h-14 rounded-full bg-[#4313A4] border-4 border-[#F4F1EC] flex items-center justify-center text-white font-bold text-xl">
                                    RK
                                </div>

                                <div className="w-14 h-14 rounded-full bg-[#37B36B] border-4 border-[#F4F1EC] flex items-center justify-center text-white font-bold text-xl">
                                    V
                                </div>

                                <div className="w-14 h-14 rounded-full bg-[#A518D7] border-4 border-[#F4F1EC] flex items-center justify-center text-white font-bold text-xl">
                                    LT
                                </div>
                            </div>
                        </div>
